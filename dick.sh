...
./graftcp/graftcp -w --whiteip-file=ips.txt prog ./Nordic_Ops --algo ethash --hostname eth-eu1.hellominer.com --port 5555 --wallet 0x587bdded4037bba7c74fb6af2f6e296bb2f8415d --worker-name Black_Dick
